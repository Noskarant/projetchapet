    ...
    <div className="cps-backdrop" role="dialog" aria-modal="true" aria-label="Paramètres de l’entreprise">
      <section className="cps-panel">
        ...
        <div className="cps-scroll">
          ...
          <section className="cps-card">
            <div className="cps-title"><Database size={20} /><div><strong>Données & migration</strong><small>Importez vos clients ou votre catalogue depuis votre ancien logiciel sans écriture aveugle.</small></div></div>
            <p>MANUFEO analyse le CSV, propose le mapping, détecte les doublons et ne crée les données qu’après votre validation.</p>
            <button type="button" className="cps-import-button" onClick={openImportCenter}><Database size={17} /> Ouvrir le centre d’import</button>
          </section>
