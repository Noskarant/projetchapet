...
export const ARTISAN_TRADE_CATALOG: ArtisanTradeDefinition[] = [
  ...
  { id: "macon", label: "Maçon", category: "batiment", aliases: ["maçonnerie", "gros œuvre"], availability: "beta", packTrade: "masonry", quoteWorkflowFit: "core" },
  { id: "carreleur", label: "Carreleur / mosaïste", category: "batiment", aliases: ["carrelage", "mosaïque"], availability: "beta", packTrade: "tiling_flooring", quoteWorkflowFit: "core" },
  { id: "solier", label: "Solier / poseur de sols", category: "batiment", aliases: ["sol souple", "vinyle", "moquette"], availability: "beta", packTrade: "tiling_flooring", quoteWorkflowFit: "core" },
  { id: "parqueteur", label: "Parqueteur", category: "amenagement_decoration", aliases: ["parquet", "pose parquet"], availability: "beta", packTrade: "tiling_flooring", quoteWorkflowFit: "core" },
  { id: "plombier", label: "Plombier", category: "batiment", aliases: ["plomberie", "sanitaire"], availability: "beta", packTrade: "plumbing_heating", quoteWorkflowFit: "core" },
  { id: "chauffagiste", label: "Chauffagiste", category: "batiment", aliases: ["chauffage", "chaudière", "pompe à chaleur"], availability: "beta", packTrade: "plumbing_heating", quoteWorkflowFit: "core" },
  { id: "climaticien", label: "Climaticien / frigoriste", category: "batiment", aliases: ["climatisation", "frigoriste", "PAC air-air"], availability: "beta", packTrade: "plumbing_heating", quoteWorkflowFit: "core" },
  { id: "electricien", label: "Électricien", category: "batiment", aliases: ["électricité", "installation électrique"], availability: "beta", packTrade: "electrician", quoteWorkflowFit: "core" },
  ...
  { id: "menuisier", label: "Menuisier", category: "bois_metal_fabrication", aliases: ["menuiserie", "menuisier bois"], availability: "beta", packTrade: "carpentry_joinery", quoteWorkflowFit: "core" },
  { id: "agenceur", label: "Agenceur / menuisier-agenceur", category: "amenagement_decoration", aliases: ["agencement", "mobilier sur mesure"], availability: "beta", packTrade: "carpentry_joinery", quoteWorkflowFit: "core" },
  ...
  { id: "couvreur", label: "Couvreur", category: "batiment", aliases: ["couverture", "toiture"], availability: "beta", packTrade: "roofing", quoteWorkflowFit: "core" },
  { id: "zingueur", label: "Zingueur", category: "batiment", aliases: ["zinguerie", "gouttière"], availability: "beta", packTrade: "roofing", quoteWorkflowFit: "core" },
  ...
  { id: "serrurier", label: "Serrurier", category: "bois_metal_fabrication", aliases: ["serrurerie", "serrure"], availability: "beta", packTrade: "locksmith_metalwork", quoteWorkflowFit: "core" },
  { id: "metallier", label: "Métallier", category: "bois_metal_fabrication", aliases: ["métallerie", "acier", "inox"], availability: "beta", packTrade: "locksmith_metalwork", quoteWorkflowFit: "core" },
  ...
  { id: "paysagiste", label: "Paysagiste", category: "exterieur", aliases: ["aménagement paysager", "jardin"], availability: "beta", packTrade: "landscaping", quoteWorkflowFit: "core" },
  { id: "jardinier", label: "Jardinier", category: "exterieur", aliases: ["entretien jardin", "espaces verts"], availability: "beta", packTrade: "landscaping", quoteWorkflowFit: "core" },
